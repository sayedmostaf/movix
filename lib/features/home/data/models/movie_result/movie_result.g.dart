...
_MovieResult _$MovieResultFromJson(Map<String, dynamic> json) => _MovieResult(
  ...
  movieCredits: json['credits'] == null
      ? null
      : MovieCredits.fromJson(json['credits'] as Map<String, dynamic>),
  movieImages: json['images'] == null
      ? null
  ...
  movieReviews: json['reviews'] == null
      ? null
      : MovieReviews.fromJson(json['reviews'] as Map<String, dynamic>),
  movieSimilar: json['similar'] == null
      ? null
      : MovieSimilar.fromJson(json['similar'] as Map<String, dynamic>),
);
...
Map<String, dynamic> _$MovieResultToJson(_MovieResult instance) =>
    <String, dynamic>{
      ...
      'credits': instance.movieCredits,
      'images': instance.movieImages,
      'videos': instance.movieVideos,
      'reviews': instance.movieReviews,
      'similar': instance.movieSimilar,
    };
