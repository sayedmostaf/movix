...
/// Create a copy of MovieReviewsResult
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MovieReviewsResultCopyWith<MovieReviewsResult> get copyWith => _$MovieReviewsResultCopyWithImpl<MovieReviewsResult>(this as MovieReviewsResult, _$identity);

  /// Serializes this MovieReviewsResult to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MovieReviewsResult&&(identical(other.author, author) || other.author == author)&&(identical(other.authorDetails, authorDetails) || other.authorDetails == authorDetails)&&(identical(other.content, content) || other.content == content)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.id, id) || other.id == id)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.url, url) || other.url == url));
}
...
/// @nodoc
abstract mixin class $MovieReviewsResultCopyWith<$Res>  {
  factory $MovieReviewsResultCopyWith(MovieReviewsResult value, $Res Function(MovieReviewsResult) _then) = _$MovieReviewsResultCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MovieReviewsResultCopyWithImpl<$Res>
    implements $MovieReviewsResultCopyWith<$Res> {
  _$MovieReviewsResultCopyWithImpl(this._self, this._then);

  final MovieReviewsResult _self;
  final $Res Function(MovieReviewsResult) _then;
...
/// Adds pattern-matching-related methods to [MovieReviewsResult].
extension MovieReviewsResultPatterns on MovieReviewsResult {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MovieReviewsResult value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MovieReviewsResult() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MovieReviewsResult value)  $default,){
final _that = this;
switch (_that) {
case _MovieReviewsResult():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MovieReviewsResult value)?  $default,){
final _that = this;
switch (_that) {
case _MovieReviewsResult() when $default != null:
return $default(_that);case _:
...
class _MovieReviewsResult implements MovieReviewsResult {
   _MovieReviewsResult({this.author, @JsonKey(name: 'author_details') this.authorDetails, this.content, @JsonKey(name: 'created_at') this.createdAt, this.id, @JsonKey(name: 'updated_at') this.updatedAt, this.url});
  factory _MovieReviewsResult.fromJson(Map<String, dynamic> json) => _$MovieReviewsResultFromJson(json);
...
@pragma('vm:prefer-inline')
_$MovieReviewsResultCopyWith<_MovieReviewsResult> get copyWith => __$MovieReviewsResultCopyWithImpl<_MovieReviewsResult>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MovieReviewsResultToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieReviewsResult&&(identical(other.author, author) || other.author == author)&&(identical(other.authorDetails, authorDetails) || other.authorDetails == authorDetails)&&(identical(other.content, content) || other.content == content)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.id, id) || other.id == id)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.url, url) || other.url == url));
}
...
/// @nodoc
abstract mixin class _$MovieReviewsResultCopyWith<$Res> implements $MovieReviewsResultCopyWith<$Res> {
  factory _$MovieReviewsResultCopyWith(_MovieReviewsResult value, $Res Function(_MovieReviewsResult) _then) = __$MovieReviewsResultCopyWithImpl;
@override @useResult
$Res call({
 String? author,@JsonKey(name: 'author_details') AuthorDetails? authorDetails, String? content,@JsonKey(name: 'created_at') DateTime? createdAt, String? id,@JsonKey(name: 'updated_at') DateTime? updatedAt, String? url
});
...
/// @nodoc
class __$MovieReviewsResultCopyWithImpl<$Res>
    implements _$MovieReviewsResultCopyWith<$Res> {
  __$MovieReviewsResultCopyWithImpl(this._self, this._then);

  final _MovieReviewsResult _self;
  final $Res Function(_MovieReviewsResult) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? author = freezed,Object? authorDetails = freezed,Object? content = freezed,Object? createdAt = freezed,Object? id = freezed,Object? updatedAt = freezed,Object? url = freezed,}) {
  return _then(_MovieReviewsResult(
author: freezed == author ? _self.author : author // ignore: cast_nullable_to_non_nullable
as String?,authorDetails: freezed == authorDetails ? _self.authorDetails : authorDetails // ignore: cast_nullable_to_non_nullable
as AuthorDetails?,content: freezed == content ? _self.content : content // ignore: cast_nullable_to_non_nullable
as String?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
