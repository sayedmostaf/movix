...
part of 'movie_similar_result.dart';
...
/// Create a copy of MovieSimilarResult
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MovieSimilarResultCopyWith<MovieSimilarResult> get copyWith => _$MovieSimilarResultCopyWithImpl<MovieSimilarResult>(this as MovieSimilarResult, _$identity);

  /// Serializes this MovieSimilarResult to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MovieSimilarResult&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other.genreIds, genreIds)&&(identical(other.id, id) || other.id == id)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.title, title) || other.title == title)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}
...
/// @nodoc
abstract mixin class $MovieSimilarResultCopyWith<$Res>  {
  factory $MovieSimilarResultCopyWith(MovieSimilarResult value, $Res Function(MovieSimilarResult) _then) = _$MovieSimilarResultCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MovieSimilarResultCopyWithImpl<$Res>
    implements $MovieSimilarResultCopyWith<$Res> {
  _$MovieSimilarResultCopyWithImpl(this._self, this._then);

  final MovieSimilarResult _self;
  final $Res Function(MovieSimilarResult) _then;
...
/// Adds pattern-matching-related methods to [MovieSimilarResult].
extension MovieSimilarResultPatterns on MovieSimilarResult {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MovieSimilarResult value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MovieSimilarResult() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MovieSimilarResult value)  $default,){
final _that = this;
switch (_that) {
case _MovieSimilarResult():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MovieSimilarResult value)?  $default,){
final _that = this;
switch (_that) {
case _MovieSimilarResult() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$MovieSimilarResultCopyWith<_MovieSimilarResult> get copyWith => __$MovieSimilarResultCopyWithImpl<_MovieSimilarResult>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MovieSimilarResultToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieSimilarResult&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other._genreIds, _genreIds)&&(identical(other.id, id) || other.id == id)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.title, title) || other.title == title)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}
...
/// @nodoc
abstract mixin class _$MovieSimilarResultCopyWith<$Res> implements $MovieSimilarResultCopyWith<$Res> {
  factory _$MovieSimilarResultCopyWith(_MovieSimilarResult value, $Res Function(_MovieSimilarResult) _then) = __$MovieSimilarResultCopyWithImpl;
@override @useResult
$Res call({
 bool? adult,@JsonKey(name: 'backdrop_path') String? backdropPath,@JsonKey(name: 'genre_ids') List<int>? genreIds, int? id,@JsonKey(name: 'original_language') String? originalLanguage,@JsonKey(name: 'original_title') String? originalTitle, String? overview, double? popularity,@JsonKey(name: 'poster_path') String? posterPath,@JsonKey(name: 'release_date') String? releaseDate, String? title, bool? video,@JsonKey(name: 'vote_average') double? voteAverage,@JsonKey(name: 'vote_count') int? voteCount
});
...
/// @nodoc
class __$MovieSimilarResultCopyWithImpl<$Res>
    implements _$MovieSimilarResultCopyWith<$Res> {
  __$MovieSimilarResultCopyWithImpl(this._self, this._then);

  final _MovieSimilarResult _self;
  final $Res Function(_MovieSimilarResult) _then;

/// Create a copy of MovieSimilarResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? adult = freezed,Object? backdropPath = freezed,Object? genreIds = freezed,Object? id = freezed,Object? originalLanguage = freezed,Object? originalTitle = freezed,Object? overview = freezed,Object? popularity = freezed,Object? posterPath = freezed,Object? releaseDate = freezed,Object? title = freezed,Object? video = freezed,Object? voteAverage = freezed,Object? voteCount = freezed,}) {
  return _then(_MovieSimilarResult(
adult: freezed == adult ? _self.adult : adult // ignore: cast_nullable_to_non_nullable
as bool?,backdropPath: freezed == backdropPath ? _self.backdropPath : backdropPath // ignore: cast_nullable_to_non_nullable
