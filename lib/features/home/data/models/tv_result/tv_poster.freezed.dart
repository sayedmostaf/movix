...
/// Create a copy of TvPoster
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TvPosterCopyWith<TvPoster> get copyWith => _$TvPosterCopyWithImpl<TvPoster>(this as TvPoster, _$identity);

  /// Serializes this TvPoster to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TvPoster&&(identical(other.aspectRatio, aspectRatio) || other.aspectRatio == aspectRatio)&&(identical(other.height, height) || other.height == height)&&(identical(other.iso6391, iso6391) || other.iso6391 == iso6391)&&(identical(other.filePath, filePath) || other.filePath == filePath)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount)&&(identical(other.width, width) || other.width == width));
}
...
@override
String toString() {
  return 'TvPoster(aspectRatio: $aspectRatio, height: $height, iso6391: $iso6391, filePath: $filePath, voteAverage: $voteAverage, voteCount: $voteCount, width: $width)';
}
...
/// @nodoc
abstract mixin class $TvPosterCopyWith<$Res>  {
  factory $TvPosterCopyWith(TvPoster value, $Res Function(TvPoster) _then) = _$TvPosterCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$TvPosterCopyWithImpl<$Res>
    implements $TvPosterCopyWith<$Res> {
  _$TvPosterCopyWithImpl(this._self, this._then);

  final TvPoster _self;
  final $Res Function(TvPoster) _then;
...
/// Adds pattern-matching-related methods to [TvPoster].
extension TvPosterPatterns on TvPoster {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TvPoster value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TvPoster() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TvPoster value)  $default,){
final _that = this;
switch (_that) {
case _TvPoster():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TvPoster value)?  $default,){
final _that = this;
switch (_that) {
case _TvPoster() when $default != null:
return $default(_that);case _:
...
class _TvPoster implements TvPoster {
   _TvPoster({@JsonKey(name: 'aspect_ratio') this.aspectRatio, this.height, @JsonKey(name: 'iso_639_1') this.iso6391, @JsonKey(name: 'file_path') this.filePath, @JsonKey(name: 'vote_average') this.voteAverage, @JsonKey(name: 'vote_count') this.voteCount, this.width});
  factory _TvPoster.fromJson(Map<String, dynamic> json) => _$TvPosterFromJson(json);
...
@pragma('vm:prefer-inline')
_$TvPosterCopyWith<_TvPoster> get copyWith => __$TvPosterCopyWithImpl<_TvPoster>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TvPosterToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TvPoster&&(identical(other.aspectRatio, aspectRatio) || other.aspectRatio == aspectRatio)&&(identical(other.height, height) || other.height == height)&&(identical(other.iso6391, iso6391) || other.iso6391 == iso6391)&&(identical(other.filePath, filePath) || other.filePath == filePath)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount)&&(identical(other.width, width) || other.width == width));
}
...
/// @nodoc
abstract mixin class _$TvPosterCopyWith<$Res> implements $TvPosterCopyWith<$Res> {
  factory _$TvPosterCopyWith(_TvPoster value, $Res Function(_TvPoster) _then) = __$TvPosterCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'aspect_ratio') double? aspectRatio, int? height,@JsonKey(name: 'iso_639_1') String? iso6391,@JsonKey(name: 'file_path') String? filePath,@JsonKey(name: 'vote_average') double? voteAverage,@JsonKey(name: 'vote_count') int? voteCount, int? width
});
...
/// @nodoc
class __$TvPosterCopyWithImpl<$Res>
    implements _$TvPosterCopyWith<$Res> {
  __$TvPosterCopyWithImpl(this._self, this._then);

  final _TvPoster _self;
  final $Res Function(_TvPoster) _then;
