      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(value, style: StylesManager.styleLatoRegular18(context)),
            if (ratingCount != null) SizedBox(width: 5),
            if (ratingCount != null)
              Text(
                '( $ratingCount)',
        ...
        Text(title, style: StylesManager.styleLatoRegular14(context)),
      ],
    );
  }
}
